  ...
  const items: MobileTabBarProps['items'] = useMemo(
    () =>
      [
        {
          icon: (active: boolean) => (
            <Icon className={active ? styles.active : undefined} icon={Mail} />
          ),
        ...
        showMarket && {
          icon: (active: boolean) => (
            <Icon className={active ? styles.active : undefined} icon={Globe} />
          ),
        ...
        {
          icon: (active: boolean) => (
            <Icon className={active ? styles.active : undefined} icon={UserCheck} />
          ),
