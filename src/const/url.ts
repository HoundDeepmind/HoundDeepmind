...
export const OFFICIAL_URL = 'https://hounddeepmind.com/';
export const OFFICIAL_PREVIEW_URL = 'https://chat-preview.hounddeepmind.com/';
export const OFFICIAL_SITE = 'https://hounddeepmind.com/';
...
// Add the missing BASE_PROVIDER_DOC_URL constant
export const BASE_PROVIDER_DOC_URL = urlJoin(DOCUMENTS, '/provider');
...
export const DISCORD = 'https://discord.gg/mwETqEPr';
export const PRIVACY_URL = urlJoin(OFFICIAL_SITE, '/privacy');
export const TERMS_URL = urlJoin(OFFICIAL_SITE, '/terms');
export const PLUGINS_INDEX_URL = 'https://chat-plugins.lobehub.com';
export const MORE_MODEL_PROVIDER_REQUEST_URL = 'https://github.com/lobehub/lobe-chat/discussions/1284';
export const MORE_FILE_PREVIEW_REQUEST_URL = 'https://github.com/lobehub/lobe-chat/discussions/3684';
export const AGENTS_INDEX_GITHUB = 'https://github.com/lobehub/lobe-chat-agents';
export const AGENTS_INDEX_GITHUB_ISSUE = urlJoin(AGENTS_INDEX_GITHUB, 'issues/new');

export const SESSION_CHAT_URL = (id: string = INBOX_SESSION_ID, mobile?: boolean) => qs.stringifyUrl({
...
export const EMAIL_SUPPORT = 'hound4753@gmail.com';
export const EMAIL_BUSINESS = 'hound4753@gmail.com';
export const MEDIDUM = 'https://medium.com/@hound_ai';
export const X = 'https://x.com/Hounddeepmind';
